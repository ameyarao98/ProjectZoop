"""
Django settings for projectzoop project.
...
SECRET_KEY = 'ld8tf1s2s&zv-elt$s55eg_$2xdf2)z2pl_)*0uqu=8t+7mj%p'
...
WSGI_APPLICATION = 'projectzoop.wsgi.application'
